...
import com.coreService.entity.message.resp.NewsMessage;
import com.coreService.entity.message.resp.TextMessage;
...
public class MessageUtil {
	...
	public static String getXmlFromRequest(HttpServletRequest request) throws Exception {
		...
		xml = ZHConverter.convert(xml, ZHConverter.SIMPLIFIED);// 繁体转换成简体
		return xml;
	}
