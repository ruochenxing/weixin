...
public class MyServletWeixinSupport extends WeixinSupport {
	...
	private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(MyServletWeixinSupport.class);
	
	private static final String WELCOME_RESP_MESSAGE = "欢迎关注网盘搜索公众号！我是网盘搜索机器人，回复'help'查看功能。";
	...
	protected BaseMsg handleDefaultMsg(BaseReqMsg msg) {
		logger.info("response default msg:");
